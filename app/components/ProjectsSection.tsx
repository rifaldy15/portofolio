...
const projects = [
  {
    ...
    description: 'Website Sistem Informasi dan Pendaftaran Siswa TK Ceria adalah sebuah platform digital yang dirancang untuk memudahkan calon orang tua dalam mendapatkan informasi dan mendaftarkan anak mereka.',
    image: '/tk.jpg',
    tags: ['Html', 'Javascript', 'Php', 'Chart.js', 'Css'],
    link: 'https://tkceria13.aicenter.my.id/', // <-- GANTI DENGAN LINK DEMO ANDA
  },
  {
    title: 'IoT Hydroponics Monitoring System',
    description: 'Platform IoT full-stack untuk otomatisasi dan pemantauan sistem hidroponik secara real-time. Dilengkapi dengan dasbor web interaktif untuk visualisasi data sensor dan kontrol aktuator jarak jauh',
    image: '/iot.jpg',
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="mt-6 flex items-center gap-4">
                  <a href={project.link} target="_blank" rel="noopener noreferrer" className="inline-block px-4 py-2 text-sm font-semibold text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition-colors">
                    Live Demo
                  </a>
                </div>
              </div>
