...
import { HiCode, HiChip, HiDatabase, HiChartBar, HiBeaker } from 'react-icons/hi';
...
const services = [
  ...
  },
  {
    icon: HiChip,
    title: 'IoT Projects',
    description: 'Developing smart devices and systems for the Internet of Things.',
  },
  {
    icon: HiChartBar,
    title: 'Data Analysis',
  ...
  },
  {
    icon: HiDatabase,
    title: 'Data Mining',
    description: 'Discovering patterns in large data sets using advanced techniques.',
  },
  {
    icon: HiBeaker,
    title: 'Data Science',
