  ...
  return (
    <section id="contact" className="py-32 px-4 bg-[#0F172A]">
      <div className="max-w-4xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="relative p-8 sm:p-12 rounded-3xl overflow-hidden bg-gray-900/50 border border-gray-700">
          {/* Grid background */}
          <div className="absolute inset-0 bg-repeat" style={{ backgroundImage: "url('/grid.svg')", opacity: 0.1, backgroundSize: '30px 30px' }} />

          <div className="relative z-10 text-center">
            <h2 className="text-4xl font-bold mb-3 text-white">Let's Connect</h2>
            <p className="text-gray-400 mb-6">Ready to collaborate or have a project in mind? Let's make something amazing together.</p>
            ...
            <div className="flex flex-col items-center gap-4">
              <motion.a
                ...
                whileHover={{ scale: 1.05, boxShadow: '0px 0px 20px rgba(109, 40, 217, 0.5)' }}
                whileTap={{ scale: 0.95 }}
            ...
            <div className="flex justify-center gap-4 mt-10">
              <motion.a href="#" target="_blank" whileHover={{ y: -4 }} className="p-3 bg-white/5 rounded-full border border-white/10 text-white hover:bg-white/10 transition-colors">
                <FaGithub size={24} />
              </motion.a>
              <motion.a href="#" target="_blank" whileHover={{ y: -4 }} className="p-3 bg-white/5 rounded-full border border-white/10 text-white hover:bg-white/10 transition-colors">
                <FaLinkedin size={24} />
