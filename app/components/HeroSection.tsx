...
const heroSkills = ['HTML', 'PHP', 'React', 'Next.js', 'Javascript', 'Tailwind CSS', 'Laravel', 'C++'];

export default function HeroSection() {
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0F172A]">
      ...
      <div className="relative z-10 text-center px-4">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-8">Frontend Developer & IoT Project</p>
