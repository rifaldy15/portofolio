...
const resumeData = {
  summary: {
    ...
    description:
      "Mahasiswa Teknik Informatika yang bersemangat, dengan fokus pada pengembangan Frontend dan minat kuat pada proyek Internet of Things. Berpengalaman dalam menciptakan antarmuka web yang responsif dan intuitif.",
  ...
  education: [
    ...
    },
    {
      ...
      description:
        "Fokus pada rekayasa perangkat lunak, pengembangan web, Internet Of Things, data mining, dan kecerdasan buatan. Aktif dalam kegiatan himpunan dan proyek-proyek akademis.",
    },
  ],
  experience: [
    {
...
export default function ResumeSection() {
  return (
    <section
      id="resume"
      className="py-32 px-4 sm:px-6 lg:px-8 bg-gray-900/50 text-gray-300">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12">
          ...
          <div>
            ...
            <h3 className="text-2xl font-semibold mt-10 mb-6 text-white">
              Education
            </h3>
            {resumeData.education.map((edu, index) => (
              <div
                key={index}
                className="relative pl-8 border-l-2 border-gray-700 pb-8">
                <div className="absolute -left-[9px] top-1 w-4 h-4 bg-gray-900 border-2 border-blue-500 rounded-full"></div>
                <h4 className="text-xl font-bold text-white">{edu.degree}</h4>
                <p className="bg-gray-800 text-blue-300 font-semibold inline-block px-3 py-1 my-2 rounded-md text-sm">
                  {edu.period}
                </p>
